---
layout: post
title: "Tmux as screen replacement adn productivity accelerator"
date: 2013-01-14T16:59:00+01:00
categories: [productivity,linux]
published: false
keywords: tmux,productivity,termianl multiplexer
description: Basic tips and tricks about tmux
---

As I wrote in [previous post](/blog/2013/03/19/debian-switching-to-unstable) I 
...
old version. Personally I use `unstable` version and `tmux` was delivered in 
...
```
After that I have implemented [solarized](http://ethanschoonover.com/solarized) colors:
```
...
are many things to set (vim, treminal, putty etc.). If you need any advice I can 
write something about this. Right now it is beyond the scope.
...
Finally I found [tmuxinator](https://github.com/aziz/tmuxinator) small bu useful 
project delivered by `gem` system. Follow tmuxinator page to set it up 
correctly. If you want to seem my primitive configuration it is also availabl on 
my github in [werkspace project]().
